...
KCM.SimpleKCM {
    ...
    footer: QQC2.ToolBar {
        ...
        // Kirigami calculates anchors based on our height, make sure we have none when invisible.
        implicitHeight: visible ? implicitHeight : 0
        implicitWidth: visible ? implicitWidth : 0
