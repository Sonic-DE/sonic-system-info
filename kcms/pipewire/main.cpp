...
class KCMPipewire : public KQuickConfigModule
{
    Q_OBJECT
    Q_PROPERTY(CommandOutputContext *infoOutputContext READ outputContext CONSTANT FINAL)
public:
    explicit KCMPipewire(QObject *parent, const KPluginMetaData &data)
...
K_PLUGIN_CLASS_WITH_JSON(KCMPipewire, "kcm_pipewire.json")
